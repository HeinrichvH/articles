...
delegations. With working cohesion data _and_ the cc damper, both files would have
...
#link("https://github.com/tiangolo/fastapi")[FastAPI] --- a well-known, well-maintained
Python framework. No tuning, no special configuration. Just:
...
#link("https://ollama.com")[ollama] embeddings --- no API keys, no cloud, just your
machine. The script splits each file into logical sections, embeds them, and measures
how similar the sections are to each other. High similarity means one concern. Low
...
#figure(
  table(
    ...
    [*File*], [*LOC*], [*CC*], [*Cohesion*], [*Score*],
    [applications.py], [4,036], [11.9], [0.63], [15.02],
    [routing.py], [4,374], [7.6], [0.59], [10.74],
    [param_functions.py], [2,323], [13.3], [0.71], [9.36],
    [dependencies/utils.py], [963], [6.8], [0.53], [3.05],
    [openapi/utils.py], [582], [11.2], [0.53], [2.70],
  ),
  caption: [Top 5 split candidates in FastAPI's source.],
)
